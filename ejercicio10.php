<?php
 ...
 if($_POST){
  ...
  if($valorA !== $valorB && $valorA > $valorB){
    ...
    echo "El valor de A es diferente al valor de B y tambien es menor. <br />";
  }else{
...
<html lang="es">
  <head>
   <meta charset="UTF-8" />
    ...
    <meta name="description" content="Curso de PHP desde cero | Operadores lógicos PHP" />
    ...
    <title>Curso de PHP desde cero | Operadores lógicos PHP</title>
  </head>
  <body>
